...
var Select = React.createClass({
  ...
  propTypes: {
    ...
    blurResetsInput: React.PropTypes.bool, //
  ...
  handleInputBlur: function handleInputBlur(event) {
    ...
    this._blurTimeout = setTimeout(function () {
      ...
      if (_this7.props.blurResetsInput) {
        newStateValues.inputValue = '';
      }
      _this7.setState(newStateValues);
    }, 50);
